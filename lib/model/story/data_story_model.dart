class DataStoryModel {
  ...
  DataStoryModel({required this.name, required this.profilepic,required this.postphoto});

}
// dummy data to show Profile post and story image and Name of the account user.
 List<DataStoryModel> dummyStoryData = [

  DataStoryModel(
      name: "Rajat Palankar",
      postphoto: "https://media1.s-nbcnews.com/j/newscms/2019_14/2808721/190403-joaquin-phoenix-joker-cs-1005a_4715890895d3fad1f9e7ccec85386821.fit-760w.jpg",
      profilepic:
