      ...
      child: Column(
        ...
        children: [
            ...
            child: Stack(
              ...
              children: [
                ...
                Align(
                  ...
                  child: InkResponse(
                    onTap: () { Get.back(); },
                    child: const Icon(Icons.keyboard_arrow_down, color: whiteColor,),
                  ),
                )
              ],
            ),
          ...
          Container(
            ...
            child: TextField(
              style: const TextStyle(color: blackColor, fontWeight: FontWeight.normal, fontSize: 18),
              decoration: const InputDecoration(
                  hintText: 'Search Country',
                  hintStyle: TextStyle(color: blackLightColor),
